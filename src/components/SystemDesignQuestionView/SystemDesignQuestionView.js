...
import "./SystemDesignQuestionView.module.css";

// Import the system design data
import systemDesignData from "../../data/systemdesign.json";

function SystemDesignQuestionView() {
  ...
  useEffect(() => {
    // Load topics from systemDesignData
    const loadedTopics = (systemDesignData.systemDesignTopics || []).map(
      (topic) => ({
        ...topic,
...
export default SystemDesignQuestionView;
